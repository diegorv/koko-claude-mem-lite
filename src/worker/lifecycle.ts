/**
 * Worker process lifecycle: PID management, stale session reaping,
 * idle auto-shutdown, graceful shutdown, and startup recovery.
 */
...
export async function checkExistingWorker(port: number): Promise<boolean> {
...
let idleShutdownInterval: ReturnType<typeof setInterval>;

export function installIdleMiddleware(app: Hono): void {
...
export function startIdleShutdown(): void {
